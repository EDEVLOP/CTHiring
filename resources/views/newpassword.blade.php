            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-12 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <form class="mt-4" action="{{route('newpassword')}}" method="post">
                            @csrf
                            <div class="">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="{{$res}}" name="tempassword_id" id="">

                                        <input class="form-control" name="password" id="pwd" type="text"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="conf_pass" id="pwd" type="text"
