    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Role Branch</h3></br>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Role Branch
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="card-body card-dashboard">
                            ...
                            <table class="table table-striped table-bordered dataex-html5-selectors">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td style="text-align: left;">{{$loc->role_name}}</td>
                                        <td style="text-align: left;">{{$loc->role_des}}</td>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="card-content collpase show">
                                                        <div class="card-body">
                                                            <form action="edit_role/{{$loc->id}}" method="get"
                                                                class="form">
                                                                @csrf
                                                                <div class="form-body">
                                                                    <div class="row">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group col-12 mb-2">
                                                                            <label
                                                                                for="timesheetinput1">Description:</label>
                                                                            <div
                                                                                class="position-relative has-icon-left">
                                                                                <textarea type="text"
                                                                                    class="form-control"
                                                                                    id="timesheetinput1" name="role_des"
                                                                                    value=""
                                                                                    placeholder="Enter User Role Description">{{$loc->role_des}}</textarea>
                                                                                <div class="form-control-position">
                                                                                    <i class="ft-map"></i>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <div class="form-group col-12 mb-2">
                                                                    ...
                                                                    <div class="position-relative has-icon-left">
                                                                        ...
                                                                        <textarea type="text" class="form-control"
                                                                            id="timesheetinput1" name="role_des"
                                                                            placeholder="Enter User Role Description"></textarea>
                                                                        <div class="form-control-position">
                                                                            <i class="ft-map"></i>
                                                                        </div>
                                                                    </div>
