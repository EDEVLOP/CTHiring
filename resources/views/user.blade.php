    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">User </h3></br>
            ...
            <div class="content-header-right col-md-6 col-12">
                <div class="dropdown float-md-right">
                    <button class="btn btn-danger dropdown-toggle round btn-glow px-2" id="dropdownBreadcrumbButton"
                        type="button" data-target="#xlarge" data-toggle="modal" aria-haspopup="true"> Add User</button>
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="role" class="form-control" id="role">
                                                                ...
                                                                <option value="{{$role1->id}}">{{$role1->role_name}}
                                                                </option>
                                                                @endforeach
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="user_location" id="" class="form-control">
                                                                ...
                                                                @foreach($location3 as $loct)
                                                                <option value="{{$loct->id}}">{{$loct->location}}
                                                                </option>
                                                                @endforeach
