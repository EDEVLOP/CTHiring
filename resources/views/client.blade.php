                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{session()->has('client')?session('client')['CLIENT_FULLNAME']:''}}"
                                                        name="fullname">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{session()->has('client')?session('client')['CLIENT_PHONE']:''}}"
                                                        name="phone">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{session()->has('client')?session('client')['CLIENT_DRNO']:''}}"
                                                        name="doorno">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="{{session()->has('client')?session('client')['CLIENT_STNAME']:''}}"
                                                        name="streetname">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="area" name="area"
                                                        value="{{session()->has('client')?session('client')['CLIENT_AREA']:''}}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="">State</label>
                                                    <select class="form-control select2" name="State" id="statename"
                                                        value="{{session()->has('client')?session('client')['CLIENT_STATE']:''}}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" id="distname"
                                                        name="districtname"
                                                        value="{{session()->has('client')?session('client')['CLIENT_DIST']:''}}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="cityname" id="city"
                                                        value="{{session()->has('client')?session('client')['CLIENT_CITY']:''}}">
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="pincode"
                                                        value="{{session()->has('client')?session('client')['CLIENT_PINCODE']:''}}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="">CRM</label>
                                                    <select class="select2 form-control" name="crm"
                                                        value="{{session()->has('client')?session('client')['CLIENT_CRM']:''}}">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="status"
                                                        value="{{session()->has('client')?session('client')['CLIENT_STATUS']:''}}">
