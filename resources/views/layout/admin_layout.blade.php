...
<body class="vertical-layout vertical-menu-modern 2-columns   menu-expanded fixed-navbar" data-open="click"
                ...
                <ul class="nav navbar-nav flex-row">
                    ...
                    <li class="nav-item mr-auto">
                        <a class="navbar-brand" href="/">
                            <img class="brand-logo lgs" alt="modern admin logo" src="assets/images/am.jpg">
                        </a>
                    </li>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="la la-home"></i><span class="menu-title"
                            data-i18n="nav.dash.main">My Plans</a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="#" data-i18n="nav.dash.ecommerce">View Events</a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="la la-home"></i><span class="menu-title"
                            data-i18n="nav.dash.main">Positions</a>
                    <ul class="menu-content">
                ...
                <li class=" nav-item"><a href="#"><i class="la la-home"></i><span class="menu-title"
                            data-i18n="nav.dash.main">Resume</a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="#" data-i18n="nav.dash.ecommerce">Create Resume</a>
                        </li>
                        <li><a class="menu-item" href="#" data-i18n="nav.dash.ecommerce">View Resume</a>
                        </li>
                    </ul>
                </li>
                <li class=" nav-item"><a href="#"><i class="la la-home"></i><span class="menu-title"
                            data-i18n="nav.dash.main">Clients</span><span
                            class="badge badge badge-info badge-pill float-right mr-2">3</span></a>
                    <ul class="menu-content">
                ...
                <li class=" nav-item"><a href="#"><i class="la la-home"></i><span class="menu-title"
                            data-i18n="nav.dash.main">Performance</a>

                </li>
                <li class=" nav-item"><a href="#"><i class="la la-home"></i><span class="menu-title"
                            data-i18n="nav.dash.main">Reports</span><span
                            class="badge badge badge-info badge-pill float-right mr-2">3</span></a>
                    <ul class="menu-content">
                ...
                <li class=" nav-item"><a href="#"><i class="la la-home"></i><span class="menu-title"
                            data-i18n="nav.dash.main">User Tracking</span><span
                            class="badge badge badge-info badge-pill float-right mr-2">3</span></a>
                    <ul class="menu-content">
                ...
                <li class=" nav-item"><a href="#"><i class="la la-home"></i><span class="menu-title"
                            data-i18n="nav.dash.main">Settings</span><span
                            class="badge badge badge-info badge-pill float-right mr-2">3</span></a>
                    <ul class="menu-content">
                        <li><a class="menu-item" href="functionalarea" data-i18n="nav.dash.ecommerce">Functional
                                Area</a>
                        </li>
                        <li><a class="menu-item" href="industry" data-i18n="nav.dash.ecommerce">Industry</a>
                        </li>
                        ...
                        <li><a class="menu-item" href="qualification" data-i18n="nav.dash.ecommerce">Qualification</a>
                            <ul class="menu-content">
                                <li><a class="menu-item" href="/qualification" data-i18n="nav.dash.ecommerce">Degree</a>
                                </li>
                                <li><a class="menu-item" href="#" data-i18n="nav.dash.ecommerce">Specialization</a>
                                </li>
                            </ul>
                        </li>
                        <li><a class="menu-item" href="#" data-i18n="nav.dash.ecommerce">Designation</a>
                            <ul class="menu-content">
                                <li><a class="menu-item" href="/client_designation"
                                        data-i18n="nav.dash.ecommerce">Client Designation</a>
                                </li>
                                <li><a class="menu-item" href="/user_designation" data-i18n="nav.dash.ecommerce">User
                                        Designation</a>
                                </li>
                            </ul>
                        </li>
                        <li><a class="menu-item" href="#" data-i18n="nav.dash.ecommerce">Branch</a>
                            <ul class="menu-content">
                                <li><a class="menu-item" href="/client_branch" data-i18n="nav.dash.ecommerce">Client
                                        Branch</a>
                                </li>
                                <li><a class="menu-item" href="/user_branch" data-i18n="nav.dash.ecommerce">User
                                        Branch</a>
                                </li>
                            </ul>
                        </li>
                        <li><a class="menu-item" href="user" data-i18n="nav.dash.ecommerce">Users</a>
                        </li>
                        <li><a class="menu-item" href="/role" data-i18n="nav.dash.ecommerce">Roles</a>
                        </li>


                        <li><a class="menu-item" href="/apikeys" data-i18n="nav.dash.ecommerce">Api Keys</a>
                        </li>
    ...
    <footer class="footer footer-static footer-light navbar-border navbar-shadow">
        <p class="clearfix blue-grey lighten-2 text-sm-center mb-0 px-2">
            <span class="float-md-left d-block d-md-inline-block">Copyright &copy; 2022 <a
                    class="text-bold-800 grey darken-2" href="#" target="_blank">CTHiring</a>, All rights reserved.
            </span>
            <span class="float-md-right d-block d-md-inline-blockd-none d-lg-block"> Made with <i
    ...
    <script src="app-assets/js/scripts/extensions/date-time-dropper.js" type="text/javascript"></script>
    <script src="app-assets/vendors/js/extensions/datedropper.min.js" type="text/javascript"></script>
    <script src="app-assets/vendors/js/extensions/timedropper.min.js" type="text/javascript"></script>
